...
//    FILE_UUID VARCHAR2(500)
    ...
    // 파일 업로드 O
    public void create(Long memberNumber, String memberId, String memberPw, String memberEmail, String memberName, String memberNickname, String memberMobile, String memberRank, int memberStatus, String fileName, String fileUploadPath, String fileUUID) {
